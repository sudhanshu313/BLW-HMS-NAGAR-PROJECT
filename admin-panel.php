...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> BANARAS LOCOMOTIVE Hospitals</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> BANARAS LOCOMOTIVE Hospital </a>
  ...
  body{
    ...
    .bg-primary {
    background: -webkit-linear-gradient(left, #342ac1, #007bff);
}
